...
// document.documentElement.scrollHeight => page
// document.querySelector('#__next').scrollHeight => page
render() {
        ...
        <>
            <header className="header">
                <div className="header__line__wrapper">
                    ...
                    <Link href="/"><a className="header__line__logo">
                        <img src="/img/logo-line.png" alt="Шашлычный мир лого"></img>
                    </a></Link>
                              <div className="header__line__adrress__box">
                                <div className="header__line__adress">
                                  <div className="header__line__img">
